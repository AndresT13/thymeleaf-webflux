package com.jandres.springboot.webflux.controllers;
...
public class ProductoController {
    ...
    public Mono<ResponseEntity<UrlResource>> verFoto( @PathVariable String nombreFoto) throws MalformedURLException {
        Path ruta = Paths.get(path).resolve(nombreFoto).toAbsolutePath();

        UrlResource imagen =  new UrlResource(ruta.toUri());
    ...
    @GetMapping( {"/listar", "/"})
    public Mono<String> vet(Model model, @PathVariable String id){
    ...
    // Otro método para guardar en la base de datos
    @PostMapping("/form")
...
/* manejar la contrapresión modo reactive driven */
    ...
    public String listarDataDriver(Model model){
        ...
        model.addAttribute("productos", new ReactiveDataDriverContextVariable(productos, 4) );
        model.addAttribute("titulo", "Listado de productos");
        return "Listar";
    }


    /* manejar la contrapresión con contrapresión un fragmento o trozo y se refiere al buffer o chunked traer un flujo de más de 1000 elementos   */
